...
The last thing I'd do differently is having Claude always check its own work. This is something I'm implementing for my second project, the Room Booking App, and its working really well. During the development of this project I would either have the same instance of CC checking its own code, or pasting the bugs I came across into Claude then having it generate prompts for CC instructing it on how to go about fixing the bugs. What I didn't have though, was instructions in the original prompt or the CLAUDE.md file instructing CC to always check for bugs and if all deliverables were being met before returning its code. This is something I have for my current project as well as testing CCs output in a seperate instance of CC then returning the results + fix instructions to the first instance for implementation.
